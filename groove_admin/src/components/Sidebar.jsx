...
const Sidebar = () => {
  return (
    <div className="bg-indigo-600 min-h-screen pl-[4vw]">
      <img
        src={assets.logo}
      ...
      <div className="flex flex-col gap-5 mt-10">
        <NavLink
          to="/add-song"
          className="'flex items-center gap-2.5 text-gray-800 bg-white border border-black p-2 pr[max(8vw,10px)] drop-shadow-[-4px_4px_#8C9CFF] text-sm font-medium"
        >
